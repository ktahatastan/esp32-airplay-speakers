...
- A3 tek sayfalık Merzarkabul modül şeması için tekrar çalıştırılabilir Python üreticisi eklendi.
...
- G0-G2 blokajları, BTL prob güvenliği, `C_SAFE` ve doğrulanmamış modül pin sıraları paftaya işlendi.

## Doğrulama

- Python üretimi: başarılı.
- KiCad CLI 10.0.6 PDF dışa aktarma: başarılı.
- ERC: `0 error / 11 warning`; uyarılar bilerek tekil bırakılan `SCK_GND`, `FMT_LOW`, `XSMT_HIGH`, `NC_DAC`, `AMP_SD_TBD`, USB ve reserved pinler.
...
- `C_SAFE` ve sürücü empedansları hâlâ blokajdır.
