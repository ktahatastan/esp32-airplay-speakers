...
| ADR-0005 iki provisioning yolunu birlikte istiyor; ESP-IDF tek scheme destekliyor | Orta | Kesin | Scheme parametre yapıldı, SoftAP varsayılan; ADR-0005'te dört seçenek kaydedildi, karar bekliyor | firmware |
