...
| Sert güç anahtarı | **Seçilen mekanik aday:** [Direnc.net: KM103 / DC-132A 12 V ışıklı 3P rocker](https://www.direnc.net/dc-132a-12v-yuvarlak-nokta-isikli-on-off-anahtar-3p-beyaz) | DC-rated mekanik anahtar veya anahtar + doğrulanmış yüksek akım MOSFET/load-switch | Sayfa kontak değeri vermiyor. Kontak 16,8 V DC'de en az 5 A'i güvenle kesebiliyor mu; pin dizilimi ve dahili 12 V LED akımı nedir? |
