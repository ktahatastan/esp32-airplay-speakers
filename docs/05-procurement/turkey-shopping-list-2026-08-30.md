...
`65 W USB-C PD adaptör -> 100 W e-marker USB-C kablo -> 20 V PD tetikleyici -> 16.8 V / 2 A ayarlı XL4015 CC/CV -> 4S balanslı BMS -> 4S1P hücre paketi`
...
| Molicel INR18650-P28A, 2.800 mAh | 4S1P paketin enerji hücreleri; aynı parti ve eşlenmiş alınmalı | [Pilburada](https://www.pilburada.com/molicel-inr-18650-p28a-37v-2800-mah-li-ion-sarjli-pil-35a-60653) | 4 | 594,00 TL | 9.504,00 TL | Kritik stok; 16 adet aynı parti yazılı teyit edilmeli |
...
**İç donanım ara toplamı:** 4.121,65 TL / hoparlör; **16.486,60 TL / dört hoparlör**.

## Harici USB-C adaptör ve kablo

| Parça / marka-model | Teknik gerekçe | Satıcı | Adet | Birim fiyat | Toplam |
|---|---|---|---:|---:|---:|
| Baseus GaN5 Pro 2C+U 65 W `CCGP120202` | Tek USB-C port kullanımında 20 V / 3,25 A PD profili; 16,8 V / 2 A şarj için yeterli güç marjı | [MediaMarkt](https://www.mediamarkt.com.tr/tr/product/_baseus-gan5-pro-2cu-65w-sarj-cihazi-beyaz-1227101.html) | 1 ortak | 2.299,00 TL | 2.299,00 TL |
| Baseus Pudding Series USB-C–USB-C 100 W, 2 m | 5 A ve e-marker; PD profilinin güvenli taşınması | [Baseus Türkiye](https://www.baseusonline.tr/products/baseus-pudding-series-type-c-to-type-c-100w-pd-hizli-sarj-kablosu-2-metre) | 1 ortak | 399,00 TL | 399,00 TL |
...
|---|---:|---:|---:|---:|
| 1 hoparlör prototipi + 1 adaptör/kablo | 4.121,65 TL | 2.698,00 TL | 250,00 TL tahmini | **7.069,65 TL** |
| 4 hoparlör + ortak 1 adaptör/kablo | 16.486,60 TL | 2.698,00 TL | 1.000,00 TL tahmini | **20.184,60 TL** |
| 4 hoparlör + 4 adaptör/kablo | 16.486,60 TL | 10.792,00 TL | 1.000,00 TL tahmini | **28.278,60 TL** |

Sarf/izolasyon bütçesi; saf nikel şerit, fish-paper, pozitif kutup halkası, silikon kablo, ısı makaronu, klemens/JST, yükseltici ve küçük pasif elemanlar için fiyat tahminidir. Nokta kaynak hizmeti, kargo ve kasa dahil değildir. 4S2P seçilirse dört paket için 16 ek P28A gerekir; yalnız hücre farkı **9.504,00 TL**'dir.
...
- P28A hücrelerin 16 adedi aynı üretim lotundan mı; kapasite ve iç direnç eşleme raporu verilebilir mi?
